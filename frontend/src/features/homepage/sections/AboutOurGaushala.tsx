...
const AboutOurGaushala = () => {
  ...
  return (
    <section className="py-16 lg:px-16 md:px-12 sm:px-8 px-4 overflow-hidden bg-linear-to-br from-background via-[#fff3e8] to-[#ffe8d0]">
      {/* Section heading */}
      <div className="text-center mb-10">
        ...
        <p className="text-base md:text-lg text-text-secondary mt-3 max-w-xl mx-auto leading-relaxed">
          {t('about.description')}
        </p>
      </div>
        ...
        <div className="w-full lg:w-1/2 flex flex-col gap-6">
          ...
          <p className="text-base md:text-lg text-text-secondary leading-relaxed">
            {t(
              ...
              'Our sanctuary began with just two rescued calves in a small shed. Over two decades of unwavering devotion, it has blossomed into a 50-acre haven dedicated to the protection and care of these divine creatures.'
            )}
          </p>
          <p className="text-base md:text-lg text-text-secondary leading-relaxed">
            {t(
