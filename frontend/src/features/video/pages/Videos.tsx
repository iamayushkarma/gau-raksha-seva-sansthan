...
const Videos = () => {
  ...
  const navigate = useNavigate();
  const videos: Video[] = videoData; // ✅ Using frontend data
  const [search, setSearch] = useState('');
  const [playingId, setPlayingId] = useState<number | null>(null);
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="max-w-md mx-auto mb-8">
            <input
              ...
              className="w-full px-4 py-2.5 rounded-full border border-gray-200 shadow-sm text-sm focus:outline-none focus:ring-2 focus:ring-primary/30"
            />
          </div>
