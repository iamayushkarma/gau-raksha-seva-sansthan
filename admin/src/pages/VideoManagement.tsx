...
import { emptyVideoForm, getYouTubeThumbnail } from '@/types/video.types.ts';
import type { Video, VideoFormData } from '@/types/video.types.ts';
      ...
      <section className="py-10 lg:px-16 md:px-12 sm:px-8 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
                ...
                >
                  ...
                  <div className="flex flex-col flex-1 p-4 gap-1">
                    ...
                    <a
                      ...
                      className="text-xs text-blue-500 hover:underline mt-1 truncate"
                    >
                      {video.youtube_url}
                    </a>
                  </div>
            ...
            <button
              onClick={openCreate}
              className="rounded-2xl border-2 border-dashed border-gray-300 bg-gray-50 hover:bg-gray-100 hover:border-gray-400 transition-colors flex flex-col items-center justify-center gap-3 p-8 min-h-52 cursor-pointer w-full"
            >
